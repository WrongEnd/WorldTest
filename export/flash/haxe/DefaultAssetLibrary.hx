...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/images/choiceBox.png", __ASSET__assets_images_choicebox_png);
		type.set ("assets/images/choiceBox.png", AssetType.IMAGE);
		className.set ("assets/images/exploreContainer.png", __ASSET__assets_images_explorecontainer_png);
		type.set ("assets/images/exploreContainer.png", AssetType.IMAGE);
		...
		id = "assets/images/choiceBox.png";
		path.set (id, id);
		
		type.set (id, AssetType.IMAGE);
		id = "assets/images/exploreContainer.png";
		path.set (id, id);
...
@:keep @:bind #if display private #end class __ASSET__assets_images_choicebox_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__assets_images_explorecontainer_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:image("assets/images/choiceBox.png") #if display private #end class __ASSET__assets_images_choicebox_png extends lime.graphics.Image {}
@:image("assets/images/exploreContainer.png") #if display private #end class __ASSET__assets_images_explorecontainer_png extends lime.graphics.Image {}
